# %% [markdown]
# # Deep Past Initiative – 訓練 v4：參數優化版
#
# v4 改進（基於 v2-gap，不改資料，只調參數）：
# - label_smoothing_factor=0.1（防過擬合，低資源 MT 標準技巧）
...
#
# 變體：dpc-train-v4b-ls02.py 將 label_smoothing_factor 改為 0.2
#
...
class Config:
    ...
    LEARNING_RATE = 2e-4
    OUTPUT_DIR = "./byt5-base-akkadian-v4"
...
logger.info("Starting Training (v4: label_smoothing=0.1, warmup=200, 15 epochs)...")
trainer.train()
